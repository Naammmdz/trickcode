...
import static com.naammm.course.domain.CourseAsserts.*;
import static com.naammm.course.web.rest.TestUtil.createUpdateProxyForBean;
import static com.naammm.course.web.rest.TestUtil.sameNumber;
...
import com.naammm.course.IntegrationTest;
...
class CourseResourceIT {
    ...
    private static final Long SMALLER_INSTRUCTOR_ID = 1L - 1L;
    ...
    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId equals to
        defaultCourseFiltering("instructorId.equals=" + DEFAULT_INSTRUCTOR_ID, "instructorId.equals=" + UPDATED_INSTRUCTOR_ID);
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId in
        defaultCourseFiltering(
            "instructorId.in=" + DEFAULT_INSTRUCTOR_ID + "," + UPDATED_INSTRUCTOR_ID,
            "instructorId.in=" + UPDATED_INSTRUCTOR_ID
        );
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId is not null
        defaultCourseFiltering("instructorId.specified=true", "instructorId.specified=false");
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId is greater than or equal to
        defaultCourseFiltering(
            "instructorId.greaterThanOrEqual=" + DEFAULT_INSTRUCTOR_ID,
            "instructorId.greaterThanOrEqual=" + UPDATED_INSTRUCTOR_ID
        );
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId is less than or equal to
        defaultCourseFiltering(
            "instructorId.lessThanOrEqual=" + DEFAULT_INSTRUCTOR_ID,
            "instructorId.lessThanOrEqual=" + SMALLER_INSTRUCTOR_ID
        );
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId is less than
        defaultCourseFiltering("instructorId.lessThan=" + UPDATED_INSTRUCTOR_ID, "instructorId.lessThan=" + DEFAULT_INSTRUCTOR_ID);
    }

    @Test
    @Transactional
    void getAllCoursesByInstructorIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedCourse = courseRepository.saveAndFlush(course);

        // Get all the courseList where instructorId is greater than
        defaultCourseFiltering("instructorId.greaterThan=" + SMALLER_INSTRUCTOR_ID, "instructorId.greaterThan=" + DEFAULT_INSTRUCTOR_ID);
    }
