...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSONPROGRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LESSONPROGRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LESSONPROGRESS actions', async () => {
      const arg = { id: 4596 };
    ...
    it('dispatches UPDATE_LESSONPROGRESS actions', async () => {
      const arg = { id: 4596 };
    ...
    it('dispatches PARTIAL_UPDATE_LESSONPROGRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LESSONPROGRESS actions', async () => {
      const arg = 42666;
