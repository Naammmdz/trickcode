  ...
  return (
    <div>
      <h2 id="course-heading" data-cy="CourseHeading">
        <Translate contentKey="trickcodeApp.course.home.title">Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="trickcodeApp.course.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/course/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="trickcodeApp.course.home.createLabel">Create new Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseList && courseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="trickcodeApp.course.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('oldPrice')}>
                  <Translate contentKey="trickcodeApp.course.oldPrice">Old Price</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('oldPrice')} />
                </th>
                ...
                <th className="hand" onClick={sort('videoPreviewUrl')}>
                  <Translate contentKey="trickcodeApp.course.videoPreviewUrl">Video Preview Url</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('videoPreviewUrl')} />
                </th>
            ...
            <tbody>
              {courseList.map((course, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`trickcodeApp.CourseLevel.${course.level}`} />
                  </td>
                  <td>
                    <Translate contentKey={`trickcodeApp.CourseStatus.${course.status}`} />
                  </td>
                  <td>{course.thumbnailUrl}</td>
                  <td>{course.videoPreviewUrl}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="trickcodeApp.course.home.notFound">No Courses found</Translate>
            </div>
          )
        )}
      </div>
