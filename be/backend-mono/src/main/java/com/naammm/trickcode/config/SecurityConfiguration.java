...
import com.naammm.trickcode.security.*;
import com.naammm.trickcode.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/courses/public")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/courses/{id:[\\d]+}")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/courses/{id:[\\d]+}/access")).authenticated()
                    // Admin and Staff endpoints for course management
                    .requestMatchers(mvc.pattern("/api/courses/my-courses")).authenticated()
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/courses")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STAFF, AuthoritiesConstants.INSTRUCTOR)
                    .requestMatchers(mvc.pattern(HttpMethod.PUT, "/api/courses/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STAFF, AuthoritiesConstants.INSTRUCTOR)
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/courses")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STAFF)
