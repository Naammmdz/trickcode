          ...
          {expandedSections.includes(section.id) && section.lessons && (
            <div className="border-t border-neutral-200 dark:border-neutral-800">
              {section.lessons.map((lesson, lessonIndex) => (
                <div
                  key={lesson.id}
                  className="px-6 py-4 flex items-center justify-between hover:bg-neutral-50 dark:hover:bg-neutral-800 border-b last:border-b-0 border-neutral-100 dark:border-neutral-800"
                >
