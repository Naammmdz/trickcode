...
const CodeBuilder = ({ initialConfig, onChange }) => {
    ...
    return (
        <div className="space-y-4 border border-neutral-200 dark:border-neutral-800 rounded-lg overflow-hidden">
            {/* Tabs */}
            <div className="flex bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
                <button
            ...
            <div className="p-4 bg-white dark:bg-neutral-900">
                {activeTab === 'description' && (
                    <div className="space-y-2">
                        <p className="text-xs text-neutral-500">Describe the problem using Markdown.</p>
                        <textarea
