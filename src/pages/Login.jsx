    ...
    <div className="selection:bg-primary/40 selection:text-white min-h-screen flex flex-col relative overflow-x-hidden bg-gray-50 dark:bg-frontier-black">
      ...
      <nav className="w-full py-2 px-6 md:px-12 flex justify-between items-center z-50 relative">
        <a className="flex items-center gap-3 group" href="/">
          ...
          <span className="text-xl font-serif tracking-tight text-gray-900 dark:text-white font-medium group-hover:text-primary transition-colors">TrickCode</span>
        </a>
        <a className="text-sm font-mono text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2 group" href="/">
          ...
          <div className="bg-white/80 dark:bg-[#121212]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-xl p-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="mb-8 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 mb-6">
                ...
                <span className="text-[10px] font-mono text-gray-600 dark:text-gray-400 uppercase tracking-widest font-bold">System Online</span>
              </div>
              <h1 className="text-3xl font-serif text-gray-900 dark:text-white mb-2 tracking-tight">Access Terminal</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400 font-light">Enter credentials to access the mainframe.</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
                <span className="bg-white dark:bg-[#151518] px-2 text-gray-500 dark:text-gray-500 font-mono">Or authenticate manually</span>
              </div>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-1.5">
                <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide ml-1">Email or Username</label>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center ml-1">
                  <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide">Password</label>
                ...
                <div className="relative group">
                  <input
                    ...
                    disabled={loading}
                  />
                  <span className="material-symbols-outlined absolute right-3 top-3 text-gray-500 dark:text-gray-600 text-sm group-focus-within:text-primary transition-colors">lock</span>
                </div>
              </div>
              ...
              >
                <span>{loading ? 'Connecting...' : 'Initiate_Session'}</span>
            ...
            <div className="mt-8 text-center pt-6 border-t border-gray-200 dark:border-white/5">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                New to the frontier?
                <Link to="/signup" className="text-gray-900 dark:text-white hover:text-primary font-bold font-mono ml-1 transition-colors underline decoration-gray-300 dark:decoration-white/20 underline-offset-4 hover:decoration-primary/50">Sign Up</Link>
              </p>
            </div>
          </div>
