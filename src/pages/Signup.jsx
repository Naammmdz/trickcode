    ...
    <div className="selection:bg-primary/40 selection:text-white min-h-screen flex flex-col relative overflow-x-hidden bg-gray-50 dark:bg-frontier-black">
      ...
      <nav className="w-full py-2 px-6 md:px-12 flex justify-between items-center z-50 relative">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="relative w-11 h-11 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
            <img
              alt="TrickCode Logo"
              className="w-full h-full object-contain rounded dark:filter dark:invert"
              src={logo}
            />
          </div>
          <span className="text-xl font-serif tracking-tight text-gray-900 dark:text-white font-medium group-hover:text-primary transition-colors">
            TrickCode
          </span>
        </Link>
        <Link to="/" className="text-sm font-mono text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2 group">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-md animate-fade-in-up">
          <div className="bg-white/80 dark:bg-[#121212]/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-xl p-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="mb-8 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 mb-6">
                ...
                <span className="text-[10px] font-mono text-gray-600 dark:text-gray-400 uppercase tracking-widest font-bold">Registration Open</span>
              </div>
              <h1 className="text-3xl font-serif text-gray-900 dark:text-white mb-2 tracking-tight">Initialize Identity</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400 font-light">Join the frontier of algorithmic mastery.</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
                <span className="bg-white dark:bg-[#151518] px-2 text-gray-500 dark:text-gray-500 font-mono">Or register manually</span>
              </div>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide ml-1">Full Name</label>
                <div className="relative group">
                  <input
                    className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-300 dark:border-white/10 rounded px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-sans"
                    ...
                    disabled={loading}
                  />
                  <span className="material-symbols-outlined absolute right-3 top-3 text-gray-500 dark:text-gray-600 text-sm group-focus-within:text-primary transition-colors">person</span>
                </div>
              </div>

              {/* Email */}
              <div className="space-y-1.5">
                <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide ml-1">Email Address</label>
                <div className="relative group">
                  <input
                    className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-300 dark:border-white/10 rounded px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-sans"
                    ...
                    disabled={loading}
                  />
                  <span className="material-symbols-outlined absolute right-3 top-3 text-gray-500 dark:text-gray-600 text-sm group-focus-within:text-primary transition-colors">mail</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide ml-1">Password</label>
                  <div className="relative group">
                    <input
                      className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-300 dark:border-white/10 rounded px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-sans"
                      placeholder="••••••••"
                ...
                <div className="space-y-1.5">
                  <label className="block text-xs font-mono text-gray-600 dark:text-gray-400 font-bold uppercase tracking-wide ml-1">Confirm</label>
                  <div className="relative group">
                    <input
                      className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-300 dark:border-white/10 rounded px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-sans"
                      placeholder="••••••••"
              ...
              <div className="flex items-center gap-1.5 mt-1 px-1">
                ...
                <span className={`text-[10px] font-mono ml-2 ${formData.password.length >= 8 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
              ...
              >
                <span>{loading ? 'Deploying...' : 'Deploy_Profile'}</span>
            ...
            <div className="mt-8 text-center pt-6 border-t border-gray-200 dark:border-white/5">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link
                  to="/login"
                  className="text-gray-900 dark:text-white hover:text-primary font-bold font-mono ml-1 transition-colors underline decoration-gray-300 dark:decoration-white/20 underline-offset-4 hover:decoration-primary/50"
                >
                  Log In
                </Link>
              </p>
          ...
          {/* Footer Links */}
          <div className="mt-8 flex justify-center gap-6 text-xs text-gray-600 dark:text-gray-500 font-mono">
