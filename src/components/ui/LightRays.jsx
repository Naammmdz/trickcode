    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 20% 15%, color-mix(in srgb, var(--light-rays-color) 60%, transparent), transparent 70%)",
          }}
        />
        <div
          aria-hidden
          ...
          style={{
            background:
              "radial-gradient(circle at 80% 10%, color-mix(in srgb, var(--light-rays-color) 50%, transparent), transparent 75%)",
          }}
        />
        {rays.map((ray) => (
          <Ray key={ray.id} {...ray} />
