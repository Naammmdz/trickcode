...
const Footer = ({ simple = false }) => {
  return (
    <footer className={`bg-[#020202] border-t border-white/10 font-sans ${simple ? 'py-8 relative z-10 mt-auto' : 'pt-16 pb-8'}`}>
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className={`${simple ? '' : 'border-t border-white/10 pt-8'} flex flex-col md:flex-row justify-between items-center gap-4`}>
          {simple ? (
            <>
              ...
              <div className="flex gap-6 text-xs text-gray-500 font-mono">
                <a className="hover:text-neon-blue transition" href="#">System Status</a>
